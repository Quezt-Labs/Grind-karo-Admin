          ...
          <Table className="min-w-full">
            <TableHeader className="bg-gray-50 dark:bg-gray-900/50">
              <TableRow className="hover:bg-transparent dark:hover:bg-transparent">
                ...
                <TableHead className="h-auto px-4 py-3 text-right text-xs font-medium uppercase tracking-wider text-gray-500">
                  Actions
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filtered.map((book) => (
                <TableRow key={book.id}>
                  ...
                  <TableCell className="px-4 py-3 font-mono text-sm text-gray-500">
                    {book.slug}
                  </TableCell>
